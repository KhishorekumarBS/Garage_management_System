                ...
                <table id="labour_table" class="table table-striped table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr id="estimate-row<?php echo $row; ?>">
                      <td class="text-right"><div class="checkbox"><label style="font-size: 1.7em"><input <?php if(isset($estimate->repair)){echo 'checked';}?> type="checkbox" name="estimate_data[<?php echo $row; ?>][repair]" /><span class="cr"><i class="cr-icon fa fa-check"></i></span></label></div></td>
                      <td class="text-right"><div class="checkbox"><label style="font-size: 1.7em"><input <?php if(isset($estimate->replace)){echo 'checked';}?> type="checkbox" name="estimate_data[<?php echo $row; ?>][replace]" /><span class="cr"><i class="cr-icon fa fa-check"></i></span></label></div></td>
                      <td class="text-right"><button data-toggle="tooltip" title="Add Parts From Our Stock" type="button" name="estimate_data[<?php echo $row; ?>][button]" onClick=loadModal(<?php echo $row; ?>); class="btn btn-success btn-sm btnsp"><i class="fa fa-plus"></i></button>
                      ...
                      <td class="text-left"><button type="button" onclick="$('#estimate-row<?php echo $row; ?>').remove();totalEstCost();" data-toggle="tooltip" title="Remove" class="btn btn-danger btn-sm"><i class="fa fa-close"></i></button></td>
                    </tr>
                    <?php $row++; } ?>
                  </tbody>
                  <tfoot>
                    <tr>
                      <td colspan="9"></td>
                      <td class="text-left"><button type="button" onclick="addEstimate();" data-toggle="tooltip" title="Add Estimate" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i></button></td>
                    </tr>
                    <tr>
            ...
            <div class="form-group pull-left">
              <label for="chkemailnotification">Email Notification?</label>
                <div class="checkbox">
                  ...
                  <input type="checkbox" id="chkemailnotification" name="email_notification" />
...
function addEstimate() {
	...
	html += '  <td class="text-right"><button data-toggle="tooltip" title="Add Parts From Our Stock" type="button" name="estimate_data[' + row + '][button]" onClick=loadModal(' + row + '); class="btn btn-success btn-sm btnsp"><i class="fa fa-plus"></i></button><input type="hidden" id="parts_id_' + row + '" name="estimate_data[' + row + '][stock_parts]" value="0" /></td>';
	...
	html += '  <td class="text-left"><button type="button" onclick="$(\'#estimate-row' + row + '\').remove();totalEstCost();" data-toggle="tooltip" title="Remove" class="btn btn-danger btn-sm"><i class="fa fa-close"></i></button></td>';
	html += '</tr>';
