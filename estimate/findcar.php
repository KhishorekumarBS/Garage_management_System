...
<div class="row">
  ...
  aria-valuemin="0" aria-valuemax="100" style="width:<?php //echo $row['work_status']; ?>%"></div>
            ...
            <div class="form-group text-right"><a data-toggle="tooltip" href="javascript:;" onClick="$('#estimate_view_<?php echo $row['car_id']; ?>').modal('show');" data-original-title="All Estimate History" style="font-weight:bold;font-size:17px;" class="btn btn-primary"><i class="fa fa-calendar-check-o"></i> Existing Estimate List</a></div>
          </div>
